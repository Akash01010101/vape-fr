...
const concated = combinedArray.concat(snusarr,regEj,iqos,coils,salt,disposable)
const combinedArray_final = {combinedArray,snusarr,concated,regEj,iqos,coils,salt,disposable}
